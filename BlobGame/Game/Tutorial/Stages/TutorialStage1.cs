...
internal class TutorialStage1 : TutorialStage {
    ...
    public TutorialStage1() {
        ...
        PointerAnimationDirection = new Vector2(MathF.Cos(MathF.PI / 2f + -55f.ToRad()), MathF.Sin(MathF.PI / 2 + -55f.ToRad()));
    }
    ...
    internal override void Load() {
        ...
        AnimatedAvatarFadeIn = new AnimatedTexture(
            AvatarTexture,
            0.65f,
            new Vector2(-100, GameApplication.PROJECTION_HEIGHT + AvatarTexture.Height),
            new Vector2(300, 300),  // TODO find size
            0,
            BASE_ZINDEX,
            new Vector2(0, 1)) {
    ...
    internal override void Draw() {
        ...
        Primitives.DrawSprite(new Vector2(-100, GameApplication.PROJECTION_HEIGHT - AvatarTexture.Height / 2), new Vector2(1, 1), new Vector2(0.5f, 0.5f), 0, 7, AvatarTexture, Color4.White);// TODO check z and size
        ...
        if (AnimatedAvatarFadeIn.IsFinished) {
            ...
            Primitives.DrawText(
                ...
                ResourceManager.ColorLoader.GetResource("dark_accent"),
                new Vector2(600, GameApplication.PROJECTION_HEIGHT / 2 - 100),
                new Vector2(0.5f, 0.5f),
                0, 9);// TODO z index
