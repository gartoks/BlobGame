...
internal class TutorialStage3 : TutorialStage {
    ...
    public TutorialStage3() {
        ...
        PointerAnimationDirection = new Vector2(MathF.Cos(135f.ToRad()), MathF.Sin(135f.ToRad()));
    ...
    internal override void Load() {
        ...
        AnimatedPointer = new AnimatedTexture(
            PointerTexture,
            0.5f,
            new Vector2(0.667f * GameApplication.PROJECTION_WIDTH, 0.273f * GameApplication.PROJECTION_HEIGHT),
            new Vector2(256, 256),
            45f.ToRad(),
            BASE_ZINDEX,
            Vector2.One / 2f) {
    ...
    internal override void Draw() {
        ...
        Primitives.DrawText(font, "This is your next piece!", ResourceManager.ColorLoader.GetResource("dark_accent"), new Vector2(600, GameApplication.PROJECTION_HEIGHT / 2 - 100), new Vector2(0.5f, 0.5f), 0, BASE_ZINDEX + 1);
