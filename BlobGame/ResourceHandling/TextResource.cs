...
internal sealed class TextResource {
    ...
    internal TextResource(string key, IReadOnlyDictionary<string, string> fallback, Func<string, IReadOnlyDictionary<string, string>?> resourceRetriever) {
        Key = key;
